...
export default function BlogCard() {
    return (
        <div className="blogCard overflow-hidden rounded-xl max-[520px]:w-3/4 max-[520px]:m-auto max-xxs:w-full">
            <div className="grid h-full">
                ...
                <div className="flex flex-col gap-4 py-6 px-4 ">
                    ...
                    <div className="blogContent grid gap-3 h-full">
                        <p className="font-rubik text-lg 2xl:text-xl 4xl:text-2xl 5xl:text-3xl">
                            <strong className="font-bold line-clamp-2">The Next Bid Trend in Crypto</strong>
                        </p>
                        <p className="line-clamp-3 text-xs 2xl:text-sm 4xl:text-base 5xl:text-lg">
